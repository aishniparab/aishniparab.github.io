...
date: 2025-02-11
description: 
tags: evolution agriculture wonder-of-life-series
categories: 
thumbnail: 
bibliography: 2025-02-11-wonder-of-life.bib
---
...
Risto Mikkulainen, in collaboration with the MIT Media Lab, conducted an experiment to test what happens when these constraints are removed <d-cite key="johnson2019flavor"></d-cite>. By simulating perfect conditions for a basil plant—continuous light, ideal nutrients, and optimized growth parameters—they found that the plant did not need to “sleep” at all. Not only did it grow larger, but it also developed a richer taste. This suggests that some biological limits are not intrinsic necessities but rather evolutionary compromises made in response to the external world. 
...
{% include figure.liquid loading="eager" path="assets/img/tree-of-life-darwin.png" class="img-fluid rounded z-depth-1" zoomable=true style="filter: grayscale(100%);" %}
Charles Darwin’s 1837 Tree of Life sketch from his First Notebook on Transmutation of Species, [mysteriously stolen from Cambridge Library in 2000 and anonymously returned years later](https://www.cam.ac.uk/stories/darwins-tree-of-life).