...
Risto Mikkulainen, in collaboration with the MIT Media Lab, conducted an experiment to test what happens when these constraints are removed {% cite johnson2019flavor %}. By simulating perfect conditions for a basil plant—continuous light, ideal nutrients, and optimized growth parameters—they found that the plant did not need to “sleep” at all. Not only did it grow larger, but it also developed a richer taste. This suggests that some biological limits are not intrinsic necessities but rather evolutionary compromises made in response to the external world. 
