...
The Helmholtz Machine was one of the first neural network models to use latent variable inference within a generative framework <d-cite key="ritchie2023neurosymbolic"></d-cite>. It combined bottom-up and top-down processes to perform unsupervised learning.
